...
public class Clazz {
    ...
    /** 学科: 1-JavaEE, 2-前端, 3-大数据, 4-Python, 5-Go */
    private Integer subject;
    /** 状态: 0-未开班, 1-已开班(在读), 2-已结课 */
    private Short status;
    /** 状态名称 (SQL 中转换，非数据库字段) */
    private String statusName;
    /** 班级人数 (通过 COUNT(student) 统计，非数据库字段) */
    ...
    public Integer getMasterId() { return masterId; }
    public void setMasterId(Integer masterId) { this.masterId = masterId; }
